...
public class ThoughtSpotMapper implements Serializable {
    ...
    @Split
    public List<ThoughtSpotMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 ExampleDBMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public ThoughtSpotSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new ThoughtSpotSource(configuration, service, recordBuilderFactory);
    }
}
